# Generated by Django 3.1.1 on 2021-08-14 03:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_vehicle', models.CharField(max_length=15, verbose_name='Type of vehicle')),
            ],
        ),
        migrations.CreateModel(
            name='Motorizado',
            fields=[
                ('user_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='motorizado', serialize=False, to='backApp.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('model', models.CharField(max_length=15, verbose_name='Model of vehicle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='backApp.colorvehicle')),
                ('type_vehicle', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='backApp.typevehicle')),
                ('veh_model', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='backApp.modelsvehicle')),
